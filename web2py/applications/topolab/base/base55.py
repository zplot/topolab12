...
class Topo(object):
    ...
    def hasse2(self):
        ...
        not_hemos_acabado = True
        if sin_asignar_rank_aux == []:
            not_hemos_acabado = False
        while not_hemos_acabado:
            for x in sin_asignar_rank:
                ...
                sin_asignar_rank_aux.remove(x)
                if sin_asignar_rank_aux == []:
                    not_hemos_acabado = False # Hemos acabado
        print 'rank = ', rank
        print
        print
...
def main():
    ...
    base_min = [[6, 2, 1], [5, 2, 1, 3], [4, 1], [3, 1],[7,2], [1,8,9], [2, 1]]
