...
class Topo(object):
    ...
    def __init__(self, puntos, abiertos):
        ...
        self.altura = niveles
        print ' linea 262 de hasse_web'
        # Ahora pasamos posición, etiquetas y aristas
...
def es_base(puntos, base):
    '''
    puntos es una lista de puntos
    base es una lista de listas de puntos
...
puntos = [1,2,3,4,5,6]
base = [[6, 2, 1], [5, 2, 1, 3], [4, 1], [3, 1], [2, 1]]
print
print
print
print 'puntos =', puntos
print 'base = ', base
print 'Es base = ', es_base(puntos, base)
print
print
print de_corchetes_a_llaves('[[3,4],[3,4,5],[5,6,7]]')
print de_llaves_a_corchetes('{{3,4},{3,4,5},{5,6,7}}')
print de_llaves_a_lista('{{3,4},{3,4,5},{5,6,7}}')
print type(de_llaves_a_lista('{{3,4},{3,4,5},{5,6,7}}'))
